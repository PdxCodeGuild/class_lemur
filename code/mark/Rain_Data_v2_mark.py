...
def main(path):
    ...
    max_rain_dates = find_max_rain(rainfall_amounts, list_of_data_dicts)
    print(f"\nThe date with the highest rainfall is {max_rain_dates[0].strftime('%d-%b-%Y')}")
    max_average_year = find_max_rain_year(list_of_data_dicts)
    print(f"\nThe year with the highest average rainfall is {max_average_year}")
