...
function checkIfValid(secondDigit, checkDigit){
    if (secondDigit == checkDigit){
        ...
        cardCheckResult.innerText = "This is a valid number."
    }
    else {
        cardCheckResult.innerText = "This is NOT a valid number.  Authorities have been alerted."
        // alert("This is NOT a valid number")
    }
}

function getInputNumber(){
    creditCardValidation(document.querySelector("#creditCardNumber").value)
}

checkButton.addEventListener('click', getInputNumber)
