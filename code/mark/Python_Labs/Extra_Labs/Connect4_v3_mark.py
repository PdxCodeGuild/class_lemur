...
class Game:
    ...
    def calc_winner(self):
        directions = ['across', 'vertical', 'diag_up', 'diag_down']
    ...
    def check_for_match(self, pos_1, pos_2, direction, match_count):
        if direction == 'across':
            ...
            position_list = [pos_1, pos_2, pos_1-match_count, pos_2+match_count]
        try:
            if self.board[position_list[0]][position_list[1]] != ' ':
...
if __name__ == '__main__':
    ...
    while True:
        active_player = list_of_players[game.moves%2].name
